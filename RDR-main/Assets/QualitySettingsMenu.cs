...
public class QualitySettingsMenu : MonoBehaviour
{
	...
	[SerializeField] private TMPro.TMP_Dropdown resolutions; // разрешение экрана
	[SerializeField] private TMPro.TMP_Dropdown qualityPreset; // пресеты качества (настраиваются в редакторе)
	[SerializeField] private TMPro.TMP_Dropdown antiAliasing; // сглаживание
	[SerializeField] private TMPro.TMP_Dropdown shadowQuality; // качество теней
	[SerializeField] private TMPro.TMP_Dropdown shadowRes; // разрешение теней
	[SerializeField] private TMPro.TMP_Dropdown textureRes; // разрешение текстур
	[SerializeField] private TMPro.TMP_Dropdown anisotropic; // анизотропная фильтрация
	...
	void BuildMenu()
	{
		resolutions.options = new List<TMPro.TMP_Dropdown.OptionData>();
		qualityPreset.options = new List<TMPro.TMP_Dropdown.OptionData>();
		antiAliasing.options = new List<TMPro.TMP_Dropdown.OptionData>();
		shadowRes.options = new List<TMPro.TMP_Dropdown.OptionData>();
		textureRes.options = new List<TMPro.TMP_Dropdown.OptionData>();
		anisotropic.options = new List<TMPro.TMP_Dropdown.OptionData>();
		shadowQuality.options = new List<TMPro.TMP_Dropdown.OptionData>();
